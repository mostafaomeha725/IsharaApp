...
class StartLearningScreenBody extends StatelessWidget {
  final VoidCallback onGoBack;

  const StartLearningScreenBody({super.key, required this.onGoBack});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        SizedBox(height: 8.h),
        const TextRowStartLearning(title: 'Use your camera to practice signs.'),
        const TextRowStartLearning(
